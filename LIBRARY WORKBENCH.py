...
#Library Workbench Created by Shivansh Singh
...
root.title('Library Workbench 6.8.3™')



my_img=ImageTk.PhotoImage(Image.open("D:\\Library2.jpg"))
...
def but1():
	...
	mydb=mysql.connector.connect(host='localhost',user='root',passwd='XTreme683',database='Library')
	my_cursor=mydb.cursor()
...
def next():
	...
	label1= Label(root,text='This Library Management Software is created by Shivansh, Vivek & Vishwas',font=('Helvetica',16))
	label1.pack()
	label2= Label(root,text='& is completely free to use under ',font=('Helvetica',16))
	label2.pack()
	label3= Label(root,text='                                   ',font=('Helvetica',16))
	label3.pack()
	label11= Label(root,text='GNU General Public License v3.0',font=('Arial',24))
	label11.pack()
	label43= Label(root,text='                                   ',font=('Helvetica',16))
	label43.pack()
	label3= Label(root,text='You can share,modify and redistribute it as per your wish',font=('Helvetica',16))
	label3.pack()
	label4= Label(root,text='It is completely Open Source Code',font=('Helvetica',16))
	label4.pack()
	label5= Label(root,text='and was Originally developed as a school project in India year 2020',font=('Helvetica',16))
	label5.pack()
	label6=Label(root,text='This program will no longer recieve any updates',font=('Helvetica',16))
	label6.pack()
	label7= Label(root,text='Developers are requested to update it according to there requirements',font=('Helvetica',16))
	label7.pack()
	label8= Label(root,text='the source code of the program is unfortunately not available here',font=('Helvetica',16))
	label8.pack()
	label9= Label(root,text='to view source code and dependencies kindly see the python pakage or github site :)',font=('Helvetica',16))
	label9.pack()
	label8= Label(root,text='                                   ',font=('Helvetica',16))
	label8.pack()
	label10= Label(root,text='https://github.com/shivanshsinghx365/Library-Workbench-6.8.3',fg='#4169E1',font=('Arial',18), cursor="hand2")
	label10.pack()
	label10.bind("<Button-1>", lambda e: callback("https://github.com/shivanshsinghx365/Library-Workbench-6.8.3"))
